...
class Level:
	...
	def setup(self):
		...
		# house
		for layer in ['HouseFloor', 'HouseFurnitureBottom']: # careful with order
			for x,y, surf in tmx_data.get_layer_by_name(layer).tiles():
				Generic((x*TILE_SIZE, y*TILE_SIZE), surf, self.all_sprites, LAYERS['house bottom'])
				
		for layer in ['HouseWalls', 'HouseFurnitureTop']: # careful with order
			for x,y, surf in tmx_data.get_layer_by_name(layer).tiles():
	...
	def reset(self):
		...
		# sky
		self.sky.star_color = [255,255,255]
